...
export const mockNotebooks: Notebook[] = [
	{
		...
		fsrsSettings: { desiredRetention: 0.9, version: 6, params: [], learningSteps: [1, 10], relearningSteps: [10], maximumInterval: 36500, enableFuzzing: true },
		position: 0,
		createdAt: weekAgo,
		updatedAt: dayAgo,
		emoji: '\u{1F9EC}',
	...
	},
	{
		...
		fsrsSettings: { desiredRetention: 0.85, version: 6, params: [], learningSteps: [1, 10], relearningSteps: [10], maximumInterval: 36500, enableFuzzing: true },
		position: 1,
		createdAt: weekAgo,
		updatedAt: now,
